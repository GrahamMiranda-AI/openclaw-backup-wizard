...
// Use process.cwd() or import.meta.url for current directory, but 'backups' should probably be relative to the app root or persistent.
// In the original code, BACKUP_DIR was path.join(__dirname, 'backups').
// Since src/config.js is in src/, process.cwd() is safer if we run from root.
