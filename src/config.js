...
// When using ESM, __dirname isn't available by default, use import.meta.dirname
// Because src/config.js is in src/, we need to go up one level to get the project root
