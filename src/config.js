...
// Assuming that config.js is inside `src/`, so we need to go up one level for __dirname
// Alternatively, since server.js used __dirname to refer to the project root,
// and src/config.js is in src/, path.join(import.meta.dirname, '..') is the root.
