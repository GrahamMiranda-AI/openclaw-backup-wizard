...
// Note: __dirname in config.js is inside src/, so we go one level up
export const BACKUP_DIR = path.join(path.dirname(__dirname), 'backups');
export const RUNTIME_DIR = path.join(path.dirname(__dirname), '.runtime');
