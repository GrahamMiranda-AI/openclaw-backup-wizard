...
// When using ESM, __dirname is not defined, instead we can use import.meta.dirname
// We want to be relative to the root folder, not src/ folder, so we do join(.., 'backups')
